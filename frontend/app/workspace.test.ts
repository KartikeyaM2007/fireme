...
const meeting = { id: 88, title: "Planning", occurred_at: "2026-07-20T09:00:00", duration_seconds: 60, participants: ["Ava"], summary: "", topics: [], chapters: [], processing_status: "ready", segments: [], actions: [] };
...
describe("Workspace", () => {
  ...
  it("sends an inclusive date range with the Clerk bearer token", async () => {
    ...
    fireEvent.change(screen.getByLabelText("Filter from date"), { target: { value: "2026-07-01" } });
    fireEvent.change(screen.getByLabelText("Filter to date"), { target: { value: "2026-07-31" } });
